...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_4X7I[0x3];                                   // 0x0089(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_16OM[0x4];                                   // 0x0094(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_JR0D[0x10];                                  // 0x00B8(0x0010) MISSED OFFSET (PADDING)
