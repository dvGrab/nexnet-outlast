...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_TJXE[0x6];                                   // 0x02F2(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_43YF[0x7];                                   // 0x03A9(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_CO8B[0x3];                                   // 0x03E9(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void Clear();
		void Refresh();
		void GetNumDebugEntries(int32_t* Return_Value);
		void Get_Debug_Item_Name(const class FText& Debug_Name, class UW_DebugInfo_C** DebugInfoWidget);
		void Get_Debug_Item_Index(int32_t Index, class UW_DebugInfo_C** DebugInfoWidget);
