...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function AC_IncapacitationHealth.AC_IncapacitationHealth_C.Score
	 */
	struct UAC_IncapacitationHealth_C_Score_Params
	{
	public:
		...
		unsigned char                                              UnknownData_20ZM[0x3];                                   // 0x0011(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
