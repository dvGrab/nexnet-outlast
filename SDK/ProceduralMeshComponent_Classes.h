...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_OGKV[0x8];                                   // 0x04B8(0x0008) Fix Super Size
		...
		unsigned char                                              UnknownData_QVA7[0x6];                                   // 0x04C2(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_KBFU[0x4];                                   // 0x050C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
