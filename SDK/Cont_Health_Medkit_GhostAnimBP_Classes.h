...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * AnimBlueprintGeneratedClass Cont_Health_Medkit_GhostAnimBP.Cont-Health-Medkit_GhostAnimBP_C
	 * Size -> 0x09ED (FullSize[0x0CD5] - InheritedSize[0x02E8])
	 */
	class UCont_Health_Medkit_GhostAnimBP_C : public URBGhostAnimInstance
	{
	public:
		unsigned char                                              UnknownData_XG4L[0x8];                                   // 0x02E8(0x0008) Fix Super Size
	...
	public:
		...
		void EvaluateGraphExposedInputs_ExecuteUbergraph_Cont_Health_Medkit_GhostAnimBP_AnimGraphNode_BlendListByBool_AC2BDA67490D9D22F496C19817E00767();
		void EvaluateGraphExposedInputs_ExecuteUbergraph_Cont_Health_Medkit_GhostAnimBP_AnimGraphNode_BlendListByBool_8C0AD33F4AC8B3BB75819EAB53B0F18C();
		void EvaluateGraphExposedInputs_ExecuteUbergraph_Cont_Health_Medkit_GhostAnimBP_AnimGraphNode_BlendListByBool_B2B7ADBA493AE523A39125A1F3555C99();
		void BlueprintInitializeAnimation();
		void AnimNotify_MedDone();
		void ExecuteUbergraph_Cont_Health_Medkit_GhostAnimBP(int32_t EntryPoint);
