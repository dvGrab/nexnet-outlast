...
namespace CG
{
	 ...
	 * 		struct FCoreUObject_FVector                        DataToStore                                                (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	 */
	bool UMagicLeapSecureStorage::PutSecureVector(const class FString& Key, const struct FCoreUObject_FVector& DataToStore)
	{
	 ...
	 * Parameters:
	 * 		class FString                                      Key                                                        (Parm, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	 * 		struct FCoreUObject_FRotator                       DataToStore                                                (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	 */
	bool UMagicLeapSecureStorage::PutSecureRotator(const class FString& Key, const struct FCoreUObject_FRotator& DataToStore)
	{
		static UFunction* fn = nullptr;
		if (!fn)
	 ...
	 * Parameters:
	 * 		class FString                                      Key                                                        (Parm, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	 * 		struct FCoreUObject_FVector                        DataToRetrieve                                             (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	 */
	bool UMagicLeapSecureStorage::GetSecureVector(const class FString& Key, struct FCoreUObject_FVector* DataToRetrieve)
	{
		static UFunction* fn = nullptr;
		if (!fn)
	 ...
	 * Parameters:
	 * 		class FString                                      Key                                                        (Parm, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	 * 		struct FCoreUObject_FRotator                       DataToRetrieve                                             (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	 */
	bool UMagicLeapSecureStorage::GetSecureRotator(const class FString& Key, struct FCoreUObject_FRotator* DataToRetrieve)
	{
		static UFunction* fn = nullptr;
		if (!fn)
