...
namespace CG
{
	...
	public:
		...
		struct FCoreUObject_FVector                                LastLocation;                                            // 0x152C(0x000C) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
