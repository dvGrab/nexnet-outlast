...
namespace CG
{
	...
	public:
		...
		struct FCoreUObject_FVector                                Timeline_0_ActorScale_3ED612744AC2F4DC5419BE9C0B125823;  // 0x0238(0x000C) ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		struct FCoreUObject_FVector                                Timeline_0_DeltaLocation_3ED612744AC2F4DC5419BE9C0B125823; // 0x0244(0x000C) ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		...
		unsigned char                                              UnknownData_UVCP[0x3];                                   // 0x0255(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
