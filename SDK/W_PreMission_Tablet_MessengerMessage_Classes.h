...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_1GBG[0x7];                                   // 0x02B9(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		struct FCoreUObject_FDateTime                              Timestamp;                                               // 0x02E8(0x0008) Edit, BlueprintVisible, ZeroConstructor, NoDestructor, ExposeOnSpawn, HasGetValueTypeHash
