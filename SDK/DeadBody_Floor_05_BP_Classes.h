...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass DeadBody_Floor_05_BP.DeadBody_Floor-05_BP_C
	 * Size -> 0x0010 (FullSize[0x04E9] - InheritedSize[0x04D9])
	 */
	class ADeadBody_Floor05_BP_C : public ADeadBodyBase_BP_C
	{
	public:
		unsigned char                                              UnknownData_IIW8[0x7];                                   // 0x04D9(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
