...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass Cont_DirectSurface_FileCabinetDrawer_3A_BP.Cont-DirectSurface-FileCabinetDrawer-3A_BP_C
	 * Size -> 0x0020 (FullSize[0x0350] - InheritedSize[0x0330])
	 */
	class AContDirectSurfaceFileCabinetDrawer3A_BP_C : public ABase_Cont_DirectSurface_SingleSpawn_BP_C
	{
	public:
