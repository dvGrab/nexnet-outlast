...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_XJ44[0x3];                                   // 0x02E5(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_5RQW[0x4];                                   // 0x02EC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_N0FS[0x5];                                   // 0x0313(0x0005) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		struct FSlateColor                                         TabTextColor;                                            // 0x0318(0x0028) Edit, BlueprintVisible, ExposeOnSpawn
		class FScriptMulticastDelegate                             OnTabSelected;                                           // 0x0340(0x0010) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable
		...
		unsigned char                                              UnknownData_E9X9[0x4];                                   // 0x0354(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void SetTabSlot(int32_t Tab, class UWidget* Widget, class UPanelSlot** Widget_As_Panel_Slot);
