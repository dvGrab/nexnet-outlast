...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_ZP8H[0x8];                                   // 0x0028(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_C1NM[0x4];                                   // 0x0074(0x0004) MISSED OFFSET (PADDING)
