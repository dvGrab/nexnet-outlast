...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_N0O0[0x8];                                   // 0x0478(0x0008) Fix Super Size
		...
		unsigned char                                              UnknownData_9GK5[0x2];                                   // 0x04EE(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_SH39[0x1];                                   // 0x04FF(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_1HGQ[0x3];                                   // 0x0519(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_P54O[0x3];                                   // 0x0531(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_KCB8[0x3];                                   // 0x0599(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_OZB5[0x3];                                   // 0x05A5(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_EMGN : 5;                                    // 0x05AC(0x0001) BIT_FIELD (PADDING)
		...
		unsigned char                                              UnknownData_JDPH[0x2];                                   // 0x05AE(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_8WJM[0x20];                                  // 0x0610(0x0020) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_Q4IC[0x20];                                  // 0x0640(0x0020) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_UBTU[0x7];                                   // 0x0661(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		struct FCoreUObject_FVector GetLastAppliedForceFromTensionConstraint(int32_t TensionConstraintIndex);
	...
	public:
		...
		unsigned char                                              UnknownData_L2NH[0x7];                                   // 0x00C9(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
	public:
		unsigned char                                              UnknownData_PI06[0x4];                                   // 0x0678(0x0004) Fix Super Size
		...
		unsigned char                                              UnknownData_0E2X[0x3];                                   // 0x0695(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_QE1B[0x20];                                  // 0x06A0(0x0020) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_RE6M[0x8];                                   // 0x06F0(0x0008) Fix size for supers
	...
	{
	public:
		unsigned char                                              UnknownData_A1M3[0x8];                                   // 0x06F8(0x0008) Fix Super Size
	...
	public:
		...
		void RebuildRopeAtPoints(float DistancePerSegment, const struct FCoreUObject_FVector& StartLocation, const struct FCoreUObject_FVector& EndLocation, bool bRelativeLocations);
		void RebuildRope();
		static UClass* StaticClass();
	};
	...
	public:
		...
		unsigned char                                              UnknownData_3TOP[0x3];                                   // 0x0691(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_PXV5[0x4];                                   // 0x069C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_SEO1[0x3];                                   // 0x06A1(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_30TF[0x28];                                  // 0x06A8(0x0028) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_OEDK[0x68];                                  // 0x06F8(0x0068) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_CH6K[0x10];                                  // 0x0028(0x0010) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_4N6Y[0x10];                                  // 0x0028(0x0010) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_PIRP[0x4];                                   // 0x0678(0x0004) Fix Super Size
		float                                                      BendStiffness;                                           // 0x067C(0x0004) Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic
		float                                                      Mass;                                                    // 0x0680(0x0004) Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic
		float                                                      DragCoefficient;                                         // 0x0684(0x0004) Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic
		...
		unsigned char                                              UnknownData_BX82[0x20];                                  // 0x06A0(0x0020) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		TArray<class UVDParticleSpringConstraint*>                 StretchConstraints;                                      // 0x06C0(0x0010) BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Protected, NativeAccessSpecifierProtected
		TArray<class UVDParticleSpringConstraint*>                 BendConstraints;                                         // 0x06D0(0x0010) BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Protected, NativeAccessSpecifierProtected
		unsigned char                                              UnknownData_PUNT[0x10];                                  // 0x06E0(0x0010) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_52T9[0x50];                                  // 0x0028(0x0050) MISSED OFFSET (PADDING)
	...
	public:
		...
		void SetAffectiveWindVector(const struct FCoreUObject_FVector& NewWindVector);
		...
		struct FCoreUObject_FVector GetAffectiveWindVector();
	...
	public:
		...
		unsigned char                                              UnknownData_7ZE8[0x7];                                   // 0x0029(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		struct FVDParticleAttachment                               Attachment;                                              // 0x0030(0x0060) NativeAccessSpecifierPublic
		unsigned char                                              UnknownData_4CI8[0x18];                                  // 0x0090(0x0018) MISSED OFFSET (PADDING)

	public:
		void SetVelocity(const struct FCoreUObject_FVector& NewVelocity);
		void SetRestitutionCoefficient(float NewRestitutionCoefficient);
		void SetRadius(float NewRadius);
		void SetMass(float NewMass);
		void SetLocation(const struct FCoreUObject_FVector& NewLocation);
		...
		struct FCoreUObject_FVector GetVelocity();
		float GetRestitutionCoefficient();
		float GetRadius();
		float GetMass();
		struct FCoreUObject_FVector GetLocation();
		...
		bool AttachToLocation(const struct FCoreUObject_FVector& Location, bool IsRelative);
		bool AttachToComponent(class UPrimitiveComponent* Component, const struct FCoreUObject_FVector& Location, bool SimulateTension, const class FName& Socket);
		bool AttachToActor(class AActor* Actor, const struct FCoreUObject_FVector& Location, bool SimulateTension, const class FName& Socket);
		void AddForce(const struct FCoreUObject_FVector& Force);
		static UClass* StaticClass();
	};
	...
	{
	public:
		unsigned char                                              UnknownData_WZ3V[0x130];                                 // 0x0028(0x0130) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void SetConstrainPlaneOrigin(const struct FCoreUObject_FVector& Origin);
		void SetConstrainPlaneNormal(const struct FCoreUObject_FVector& Normal);
		...
		bool k2QuerySphereOverlaps(const struct FCoreUObject_FVector& Location, float Radius, TArray<class UVDSimulatedParticle*>* Overlaps, TArray<class UVDSimulatedObject*> SimObjectsToIgnore, int32_t MaxOverlaps);
		bool k2QueryBoxOverlaps(const struct FCoreUObject_FVector& Location, const struct FCoreUObject_FVector& HalfExtents, TArray<class UVDSimulatedParticle*>* Overlaps, TArray<class UVDSimulatedObject*> SimObjectsToIgnore, int32_t MaxOverlaps);
		struct FVDSettings GetSettings();
		bool GetIsRunningOnWorkerThread();
		bool GetIsExplicitRigidBodyCollisionEnabled();
		void GetDirectionalWindParameters(class UBaseVDComponent* VDComponent, struct FCoreUObject_FVector* OutDirection, float* OutSpeed, float* OutGust);
	...
	public:
		...
		unsigned char                                              UnknownData_UPNC[0x4];                                   // 0x0264(0x0004) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_KLMB[0x10];                                  // 0x0720(0x0010) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_0RWB[0x3];                                   // 0x0721(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_1UOR[0x8];                                   // 0x0728(0x0008) MISSED OFFSET (PADDING)
	 ...
	 */
	class AVDWindDirectionalSourceActor : public FEngine_AInfo
	{
	public:
	...
	{
	public:
		unsigned char                                              UnknownData_CQ0U[0x4];                                   // 0x01F8(0x0004) Fix Super Size
		...
		unsigned char                                              UnknownData_03XL[0x1C];                                  // 0x0224(0x001C) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_MMJJ[0x3];                                   // 0x0039(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_9TVC[0x3];                                   // 0x0049(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		struct FCoreUObject_FVector                                PlaneOrigin;                                             // 0x004C(0x000C) Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic
		struct FCoreUObject_FVector                                PlaneNormal;                                             // 0x0058(0x000C) Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic
		...
		unsigned char                                              UnknownData_V5GY[0x3];                                   // 0x0065(0x0003) MISSED OFFSET (PADDING)
