...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_NCLX[0x2];                                   // 0x006A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		struct FCoreUObject_FVector2D                              ShadowOffset_30_D57920BE4AFEDB45E8AA06A18138355A;        // 0x006C(0x0008) Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
