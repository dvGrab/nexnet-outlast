...
namespace CG
{
	 ...
	 */
	class ACoverGenOverrideVolume : public FEngine_AVolume
	{
	public:
		...
		unsigned char                                              UnknownData_54Z0[0x18];                                  // 0x0290(0x0018) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              bIsCrouchOnlyCover : 1;                                  // 0x029C(0x0001) BIT_FIELD Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnTemplate, EditConst, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic
		unsigned char                                              bOverrideCoverType : 1;                                  // 0x029C(0x0001) BIT_FIELD Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnTemplate, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected
		...
		unsigned char                                              UnknownData_J5WH[0x1];                                   // 0x029F(0x0001) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_RZ4U[0x88];                                  // 0x0040(0x0088) MISSED OFFSET (PADDING)

	public:
		bool ReleaseCover(const struct FCoreUObject_FVector& InCoverPoint);
		bool OccupyCover(const struct FCoreUObject_FVector& InCoverPoint);
		bool IsCoverPointOccupied(const struct FCoreUObject_FVector& InCoverLocation);
		static UClass* StaticClass();
	};
	...
	public:
		...
		unsigned char                                              UnknownData_1YLM[0x4];                                   // 0x0514(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_9IAI[0x70];                                  // 0x0538(0x0070) MISSED OFFSET (PADDING)
