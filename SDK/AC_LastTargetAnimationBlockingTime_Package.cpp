...
namespace CG
{
	...
	float UAC_LastTargetAnimationBlockingTime_C::Score(const struct FAIActionDecisionContext& Context, bool* bSuccess)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function AC_LastTargetAnimationBlockingTime.AC_LastTargetAnimationBlockingTime_C.Score");
		
		UAC_LastTargetAnimationBlockingTime_C_Score_Params params {};
	...
	UClass* UAC_LastTargetAnimationBlockingTime_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass("BlueprintGeneratedClass AC_LastTargetAnimationBlockingTime.AC_LastTargetAnimationBlockingTime_C");
		return ptr;
	}
