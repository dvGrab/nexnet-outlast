...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_AG21[0x7];                                   // 0x0431(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		struct FSavedLoadout                                       ActiveLoadout;                                           // 0x0438(0x0178) Edit, BlueprintVisible, DisableEditOnInstance
		TMap<EItemCategory, class UClass*>                         CurrentItems;                                            // 0x05B0(0x0050) Edit, BlueprintVisible, DisableEditOnInstance
		class FScriptMulticastDelegate                             OnMunitionSlotClicked;                                   // 0x0600(0x0010) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable
		class FScriptMulticastDelegate                             OnMunitionSlotHovered;                                   // 0x0610(0x0010) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable
		class FScriptMulticastDelegate                             OnMunitionSlotUnhovered;                                 // 0x0620(0x0010) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable
		...
		unsigned char                                              UnknownData_JNZ1[0x7];                                   // 0x06A1(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		class UClass*                                              Armor;                                                   // 0x06B0(0x0008) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash
		TArray<class UClass*>                                      EquippedGrenades;                                        // 0x06B8(0x0010) Edit, BlueprintVisible, DisableEditOnInstance
		TArray<class UClass*>                                      EquippedTacticals;                                       // 0x06C8(0x0010) Edit, BlueprintVisible, DisableEditOnInstance
		TMap<class UClass*, int32_t>                               GrenadeCounts;                                           // 0x06D8(0x0050) Edit, BlueprintVisible, DisableEditOnInstance
		TMap<class UW_Loadout_MunitionSlots_Deployable_C*, class UClass*> GrenadeSlots;                                            // 0x0728(0x0050) Edit, BlueprintVisible, DisableEditOnInstance, ContainsInstancedReference
		TMap<class UClass*, int32_t>                               TacticalCounts;                                          // 0x0778(0x0050) Edit, BlueprintVisible, DisableEditOnInstance
		TMap<class UW_Loadout_MunitionSlots_Deployable_C*, class UClass*> TacticalSlots;                                           // 0x07C8(0x0050) Edit, BlueprintVisible, DisableEditOnInstance, ContainsInstancedReference
		...
		unsigned char                                              UnknownData_ETEB[0x3];                                   // 0x082D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		TArray<class UClass*>                                      ListExclusionItems;                                      // 0x0830(0x0010) Edit, BlueprintVisible, DisableEditOnInstance
		...
		unsigned char                                              UnknownData_WZLH[0x4];                                   // 0x0844(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		class FScriptMulticastDelegate                             OnMunitionSlotCountChanged;                              // 0x0848(0x0010) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable
		...
		unsigned char                                              UnknownData_TRTJ[0x6];                                   // 0x085A(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		class FScriptMulticastDelegate                             OnSidearmAmmoChanged;                                    // 0x0860(0x0010) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable
		class FScriptMulticastDelegate                             OnPrimaryAmmoChanged;                                    // 0x0870(0x0010) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable
		class FScriptMulticastDelegate                             OnGrenadesChanged;                                       // 0x0880(0x0010) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable
		...
		TMap<class UClass*, class UW_Loadout_Munition_SummaryEntry_C*> GrenadeSummaryEntries;                                   // 0x08B0(0x0050) Edit, BlueprintVisible, DisableEditOnInstance, ContainsInstancedReference
		TMap<class UClass*, class UW_Loadout_Munition_SummaryEntry_C*> TacticalSummaryEntries;                                  // 0x0900(0x0050) Edit, BlueprintVisible, DisableEditOnInstance, ContainsInstancedReference
		...
		TArray<class UClass*>                                      AllGrenadeTypes;                                         // 0x0958(0x0010) Edit, BlueprintVisible, DisableEditOnInstance
		TArray<class UClass*>                                      AllTacticalTypes;                                        // 0x0968(0x0010) Edit, BlueprintVisible, DisableEditOnInstance
		...
		unsigned char                                              UnknownData_RW8C[0x1];                                   // 0x097F(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_R0Q1[0x3];                                   // 0x0985(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void CreateItemSummaryEntry(class UClass* ItemData, int32_t Count, class UW_Loadout_Munition_SummaryEntry_C** EntryWidget);
		void CreateAmmoSummaryEntry(class UClass* Weapon, const class FName& AmmoType, int32_t Count, class UW_Loadout_Munition_SummaryEntry_C** EntryWidget);
		void UpdateSummary();
		...
		void InitializeTacticals(TArray<class UClass*>* Tacticals);
		...
		void HideSlotEditor();
		void AmmoSelected(const class FName& NewAmmoType, class UClass* Weapon);
