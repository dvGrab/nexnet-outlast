...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_MARV[0x2];                                   // 0x0AFA(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_ZLNG[0x4];                                   // 0x0B04(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_TW3D[0x5];                                   // 0x0B2B(0x0005) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_UKEV[0x6];                                   // 0x0B42(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_Z62X[0x7];                                   // 0x0B51(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void AllPlayersReady(bool* Return_Value);
		void GetNumPlayers(int32_t* Return_Value);
		...
		void HandleMenuWideMultiInput_Up(const struct FKeyEvent& Input, bool* Return_Value);
		void HandleMenuWideMultiInput_Down(const struct FKeyEvent& Input, bool* Return_Value);
		void OnTransitionToQuartermasterFinished();
		void HideHUD();
		void ShowHUD();
		void ReflectHUDSettings();
		void SmoothCountdown(float DeltaTime);
		void AllowTeamSwapping(bool* Return_Value);
		...
		void IsUIHidden(bool* Return_Value);
		...
		void IsValidSelectionIndex(bool* Return_Value);
		bool CanUnselect();
		bool CanExit();
		...
		void SetNavigationMode_Mouse();
		void SetNavigationMode_Keyboard();
		void Escape();
		void ResumeGame();
		...
		void IsAnyoneOnMLOTeam(bool* Return_Value);
		void IsAnyoneOnSWATTeam(bool* Return_Value);
		...
		void BndEvt__W_PlanningMap_K2Node_ComponentBoundEvent_12_PanMap__DelegateSignature(bool Pressed, const struct FCoreUObject_FVector2D& CursorPos);
