...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_D9TU[0x7];                                   // 0x02F1(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		class FScriptMulticastDelegate                             OnSkinItemButtonClicked;                                 // 0x0328(0x0010) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable
	...
	public:
		...
		void Find_Grid_Index_From_Skin_Item_Widget(class UW_SkinItem_C* InSkinItemWidget, int32_t* Out_Row, int32_t* Out_Column);
		void FindAttachmentItemWidgetAt(int32_t InRow, int32_t InColumn, class UW_SkinItem_C** Return_Value);
		...
		void CreateSkinItemWidget(class UClass* SkinClass, int32_t InRow, int32_t InColumn);
		void ExpandChildren();
