...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function AC_Health.AC_Health_C.Score
	 */
	struct UAC_Health_C_Score_Params
	{
	public:
		...
		unsigned char                                              UnknownData_8442[0x3];                                   // 0x0011(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
