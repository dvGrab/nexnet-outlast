...
namespace CG
{
	...
	public:
		void GetIconImageFromClass(class UClass* InItemClass, class UTexture2D** Return_Value);
		void GetIconImageFromCategory(EItemCategory InItemCategory, class UTexture2D** Return_Value);
