...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function AC_TargetHealth.AC_TargetHealth_C.Score
	 */
	struct UAC_TargetHealth_C_Score_Params
	{
	public:
		...
		unsigned char                                              UnknownData_FCOV[0x3];                                   // 0x0011(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
