...
namespace CG
{
	...
	float UAC_StunTime_C::Score(const struct FAIActionDecisionContext& Context, bool* bSuccess)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function AC_StunTime.AC_StunTime_C.Score");
		
		UAC_StunTime_C_Score_Params params {};
	...
	UClass* UAC_StunTime_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass("BlueprintGeneratedClass AC_StunTime.AC_StunTime_C");
		return ptr;
	}
