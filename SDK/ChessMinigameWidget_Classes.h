...
namespace CG
{
	 ...
	 */
	class UChessMinigameWidget_C : public UUserWidget
	{
	public:
		...
		class UImage*                                              Image_213;                                               // 0x0288(0x0008) BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash
		...
		class UTextBlock*                                          LocalTeamTime_TXT_2;                                     // 0x02B8(0x0008) BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash
		...
		class UProgressBar*                                        ProgressBar_163;                                         // 0x02F8(0x0008) BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash
		...
		class UTextBlock*                                          TextBlock_161;                                           // 0x0308(0x0008) BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash
	...
	public:
		...
		class FText Get_WaitingForPlayer_TXT_1_Text_1();
		class FText Get_MatchCountdownText_Text_1();
		float GetExitingPercent();
		void OnExitingChange(bool bExiting, float StartExitTimestamp);
		void SetBindLocalPanel(bool bBind);
		class FString GetCroppedName(const class FString& Name, int32_t MaxChars);
		...
		void Init(class ARBChessBoardBase_C* ChessBoard, class URBChessBoardPanelComponent* LocalPanel);
		void Construct();
		void BindEvents();
		void UnbindEvents();
		void Destruct();
		void ExecuteUbergraph_ChessMinigameWidget(int32_t EntryPoint);
