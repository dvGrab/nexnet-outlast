...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass Murkoff_ExitCeilingBorder_Straight_01_BP.Murkoff_ExitCeilingBorder_Straight-01_BP_C
	 * Size -> 0x0002 (FullSize[0x0413] - InheritedSize[0x0411])
	 */
	class AMurkoff_ExitCeilingBorder_Straight__BP_C : public AMeshPopulate_BP_C
	{
	public:
