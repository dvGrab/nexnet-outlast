...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass WallLamp_06.WallLamp-06_C
	 * Size -> 0x0022 (FullSize[0x0780] - InheritedSize[0x075E])
	 */
	class AWallLamp__C : public ARBLight_BP_C
	{
	public:
		unsigned char                                              UnknownData_OFX7[0x2];                                   // 0x075E(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		class URBSpotLightComponent*                               SpotLight_Movable;                                       // 0x0768(0x0008) BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash
