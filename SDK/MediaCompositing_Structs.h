...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_NSV4[0x3];                                   // 0x0045(0x0003) MISSED OFFSET (PADDING)
	};
	...
	public:
		...
		unsigned char                                              UnknownData_QHPQ[0x3];                                   // 0x0029(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
