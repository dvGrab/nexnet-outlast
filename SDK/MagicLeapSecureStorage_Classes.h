...
namespace CG
{
	...
	{
	public:
		bool PutSecureVector(const class FString& Key, const struct FCoreUObject_FVector& DataToStore);
		...
		bool PutSecureRotator(const class FString& Key, const struct FCoreUObject_FRotator& DataToStore);
		...
		bool GetSecureVector(const class FString& Key, struct FCoreUObject_FVector* DataToRetrieve);
		...
		bool GetSecureRotator(const class FString& Key, struct FCoreUObject_FRotator* DataToRetrieve);
