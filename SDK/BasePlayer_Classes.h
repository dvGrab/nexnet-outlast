...
namespace CG
{
	...
	public:
		...
		float                                                      Current_Muscle_Strength;                                 // 0x21D0(0x0004) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		float                                                      Muscle_Strength;                                         // 0x21D4(0x0004) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		float                                                      Muscle_Strength_DEAD;                                    // 0x21D8(0x0004) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		bool                                                       In_Air_Muscle_Strength_Switch;                           // 0x21DC(0x0001) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor
		bool                                                       In_Air_Switch_Delay;                                     // 0x21DD(0x0001) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor
		...
		unsigned char                                              UnknownData_I0N3[0x1];                                   // 0x21DF(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void OnLeanStart();
		void OnLeanEnd();
		void PlayVaultAnimation(const struct FCoreUObject_FVector& ledge, const struct FCoreUObject_FVector& ledgeWallNormal, const struct FCoreUObject_FVector& ledgeTraceDown, float ledgeZ, ELedgeWidth ledgeWidth, ELedgeHeight ledgeHeight);
