...
namespace CG
{
	 ...
	 */
	struct UW_WeaponWheel_ItemStat_Damage_C_Initialize_Params
	{	};
	 ...
	 */
	struct UW_WeaponWheel_ItemStat_Damage_C_OnRefresh_Params
	{	};

	/**
	 * Function W_WeaponWheel_ItemStat_Damage.W_WeaponWheel_ItemStat_Damage_C.OnWheelCreated
	 */
	struct UW_WeaponWheel_ItemStat_Damage_C_OnWheelCreated_Params
	{	};
