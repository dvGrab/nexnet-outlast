...
namespace CG
{
	...
	public:
		...
		struct FModioFilterParams MarkedLiveBefore(struct FModioFilterParams* Filter, const struct FCoreUObject_FDateTime& LiveBefore);
		struct FModioFilterParams MarkedLiveAfter(struct FModioFilterParams* Filter, const struct FCoreUObject_FDateTime& LiveAfter);
	...
	public:
		...
		struct FCoreUObject_FVector2D GetLogoSize(class UTexture* Logo, EModioLogoSize LogoSize);
		struct FCoreUObject_FVector2D GetGallerySize(class UTexture* GalleryImage, EModioGallerySize GallerySize);
		struct FCoreUObject_FVector2D GetAvatarSize(class UTexture* Avatar, EModioAvatarSize AvatarSize);
		static UClass* StaticClass();
	};
	...
	public:
		class UModioPopupBase* PushPopup(class UClass* PopupClass);
		class UModioPopupBase* PopPopup(class UClass* PopupClass);
		static UClass* StaticClass();
	};
	...
	public:
		...
		unsigned char                                              UnknownData_ZMMT[0x5];                                   // 0x0043(0x0005) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_RWX4[0x148];                                 // 0x0030(0x0148) MISSED OFFSET (PADDING)
