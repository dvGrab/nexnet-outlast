...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function AC_Morale.AC_Morale_C.Score
	 */
	struct UAC_Morale_C_Score_Params
	{
	public:
		...
		unsigned char                                              UnknownData_UI62[0x3];                                   // 0x0011(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
