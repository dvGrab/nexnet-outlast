...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_C3AP[0x4];                                   // 0x01F8(0x0004) Fix Super Size
		...
		unsigned char                                              UnknownData_AY72[0xC];                                   // 0x0204(0x000C) MISSED OFFSET (PADDING)
	...
	public:
		...
		TArray<struct FCoreUObject_FVector>                        DecalLocations;                                          // 0x00B8(0x0010) BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NativeAccessSpecifierPublic
		...
		unsigned char                                              UnknownData_X1OR[0x2];                                   // 0x00DE(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_BQW0[0x3];                                   // 0x00FD(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		int32_t SpawnDecal(const struct FCoreUObject_FVector& Location, const struct FCoreUObject_FQuat& Rotation, const class FName& BoneName, float Size, int32_t SubUV, int32_t Index);
		void SetupMaterials();
