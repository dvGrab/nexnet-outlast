...
namespace CG
{
	...
	bool UAG_HasEverShot_C::CanOpen(const struct FAIActionDecisionContext& Context)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function AG_HasEverShot.AG_HasEverShot_C.CanOpen");
		
		UAG_HasEverShot_C_CanOpen_Params params {};
	...
	UClass* UAG_HasEverShot_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass("BlueprintGeneratedClass AG_HasEverShot.AG_HasEverShot_C");
		return ptr;
	}
