...
namespace CG
{
	 ...
	 * Parameters:
	 * 		struct FModioFilterParams                          Filter                                                     (Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
	 * 		struct FCoreUObject_FDateTime                      LiveBefore                                                 (Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	 */
	struct FModioFilterParams UModioFilterParamsLibrary::MarkedLiveBefore(struct FModioFilterParams* Filter, const struct FCoreUObject_FDateTime& LiveBefore)
	{
		static UFunction* fn = nullptr;
		if (!fn)
	 ...
	 * Parameters:
	 * 		struct FModioFilterParams                          Filter                                                     (Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
	 * 		struct FCoreUObject_FDateTime                      LiveAfter                                                  (Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	 */
	struct FModioFilterParams UModioFilterParamsLibrary::MarkedLiveAfter(struct FModioFilterParams* Filter, const struct FCoreUObject_FDateTime& LiveAfter)
	{
		static UFunction* fn = nullptr;
		if (!fn)
	 ...
	 */
	struct FCoreUObject_FVector2D UModioImageLibrary::GetLogoSize(class UTexture* Logo, EModioLogoSize LogoSize)
	{
		static UFunction* fn = nullptr;
		if (!fn)
	 ...
	 */
	struct FCoreUObject_FVector2D UModioImageLibrary::GetGallerySize(class UTexture* GalleryImage, EModioGallerySize GallerySize)
	{
		static UFunction* fn = nullptr;
		if (!fn)
	 ...
	 */
	struct FCoreUObject_FVector2D UModioImageLibrary::GetAvatarSize(class UTexture* Avatar, EModioAvatarSize AvatarSize)
	{
		static UFunction* fn = nullptr;
		if (!fn)
	...
	bool UModioInstallationOverride::OverrideModInstallationDirectory(const class FString& NewInstallPath, const struct FModioInitializeOptions& InitParams)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function Modio.ModioInstallationOverride.OverrideModInstallationDirectory");
		
		UModioInstallationOverride_OverrideModInstallationDirectory_Params params {};
	...
	UClass* UModioInstallationOverride::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass("Class Modio.ModioInstallationOverride");
		return ptr;
	}
