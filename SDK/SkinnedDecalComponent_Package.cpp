...
namespace CG
{
	 ...
	 * 		struct FCoreUObject_FQuat                          Rotation                                                   (ConstParm, Parm, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	 ...
	 */
	int32_t USkinnedDecalSampler::SpawnDecal(const struct FCoreUObject_FVector& Location, const struct FCoreUObject_FQuat& Rotation, const class FName& BoneName, float Size, int32_t SubUV, int32_t Index)
	{
		static UFunction* fn = nullptr;
		if (!fn)
