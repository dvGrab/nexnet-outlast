...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_G0LW[0x3];                                   // 0x02A9(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		void IsFadingOut(bool* Return_Value);
		void IsFadeOutTimerActive(bool* Return_Value);
