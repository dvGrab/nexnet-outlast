...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass HealthBoost_Consumable_BP.HealthBoost-Consumable_BP_C
	 * Size -> 0x0011 (FullSize[0x0A01] - InheritedSize[0x09F0])
	 */
	class AHealthBoost_Consumable_BP_C : public ASimpleMesh_Pickup_BP_C
	{
	public:
	...
	public:
		...
		void ExecuteUbergraph_HealthBoost_Consumable_BP(int32_t EntryPoint);
