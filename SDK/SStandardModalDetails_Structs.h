...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_8SSF[0x5];                                   // 0x0033(0x0005) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		class FText                                                OkButtonText_20_F49F44344D3A0F0CBB7DCC8BCB17010E;        // 0x0038(0x0018) Edit, BlueprintVisible
		struct FCoreUObject_FVector2D                              Size_28_F9A951CA4483BA8FED7F839B4DCF7AAA;                // 0x0050(0x0008) Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
