...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_HJHX[0x3];                                   // 0x03BD(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_QOPQ[0x7];                                   // 0x0409(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void Construct();
		void OnBodyPartHit(bool Head, bool bBodyHit, bool Left_Arm, bool Right_Arm, bool Left_Leg, bool Right_Leg);
