...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass Orphanage_FloorBorderMoldings_01_BP.Orphanage_FloorBorderMoldings-01_BP_C
	 * Size -> 0x0002 (FullSize[0x0413] - InheritedSize[0x0411])
	 */
	class AOrphanage_FloorBorderMoldings__BP_C : public AMeshPopulate_BP_C
	{
	public:
