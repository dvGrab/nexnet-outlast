...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_PBFT[0x3];                                   // 0x0065(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		void IsCivilianNotFacingTarget(class ACivilianCharacter* Civilian, class AReadyOrNotCharacter* Target, bool* Return_Value);
		void IsCivilianFacingTarget(class ACivilianCharacter* Civilian, class AReadyOrNotCharacter* Target, bool* Return_Value);
		void AnySWATNearCivilian(class ACivilianCharacter* Civilian, bool* Return_Value);
		void OnTakeHostageFinished(class UBaseActivity* Activity, class ACyberneticController* Controller);
		void TraceForNearbyCivilians(TArray<class ACivilianCharacter*>* Return_Value);
		bool ShouldPerformAction();
		void FindClosestCivilian(TArray<class ACivilianCharacter*>* Civilians, class ACivilianCharacter** Return_Value);
