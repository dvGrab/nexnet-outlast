...
namespace CG
{
	 ...
	 * 		Flags  -> ()
	 * Parameters:
	 * 		struct FCoreUObject_FVector                        Position                                                   (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	 * 		struct FCoreUObject_FRotator                       Orientation                                                (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	 * 		ESteamVRHand                                       hand                                                       (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	 ...
	 */
	bool USteamVRInputDeviceFunctionLibrary::GetSteamVR_HandPoseRelativeToNow(struct FCoreUObject_FVector* Position, struct FCoreUObject_FRotator* Orientation, ESteamVRHand hand, float PredictedSecondsFromNow)
	{
		static UFunction* fn = nullptr;
		if (!fn)
	 ...
	 * 		struct FCoreUObject_FVector                        Position                                                   (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	 * 		struct FCoreUObject_FRotator                       Orientation                                                (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	 * 		struct FCoreUObject_FVector                        AngularVelocity                                            (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	 * 		struct FCoreUObject_FVector                        Velocity                                                   (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	 */
	void USteamVRInputDeviceFunctionLibrary::GetRightHandPoseData(struct FCoreUObject_FVector* Position, struct FCoreUObject_FRotator* Orientation, struct FCoreUObject_FVector* AngularVelocity, struct FCoreUObject_FVector* Velocity)
	{
		static UFunction* fn = nullptr;
		if (!fn)
	 ...
	 * 		struct FCoreUObject_FVector                        Velocity                                                   (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	 */
	void USteamVRInputDeviceFunctionLibrary::GetLeftHandPoseData(struct FCoreUObject_FVector* Position, struct FCoreUObject_FRotator* Orientation, struct FCoreUObject_FVector* AngularVelocity, struct FCoreUObject_FVector* Velocity)
	{
		static UFunction* fn = nullptr;
		if (!fn)
