...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass GrandFatherClockFace_01_BP.GrandFatherClockFace-01_BP_C
	 * Size -> 0x004D (FullSize[0x02A5] - InheritedSize[0x0258])
	 */
	class AGrandFatherClockFace__BP_C : public ARBStationnaryActor_C
	{
	public:
		...
		unsigned char                                              UnknownData_U3FK[0x3];                                   // 0x0299(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void StopClock();
		void ExecuteUbergraph_GrandFatherClockFace__BP(int32_t EntryPoint);
