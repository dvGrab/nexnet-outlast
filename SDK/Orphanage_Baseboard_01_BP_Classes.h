...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass Orphanage_Baseboard_01_BP.Orphanage_Baseboard-01_BP_C
	 * Size -> 0x0010 (FullSize[0x05A0] - InheritedSize[0x0590])
	 */
	class AOrphanage_Baseboard__BP_C : public AWall__BP_C
	{
	public:
		...
		unsigned char                                              UnknownData_UU21[0x2];                                   // 0x0592(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
