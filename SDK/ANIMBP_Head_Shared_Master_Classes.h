...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_617J[0x3];                                   // 0x15D1(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		struct FCoreUObject_FRotator                               HeadLookRotation;                                        // 0x15D8(0x000C) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor
		...
		struct FCoreUObject_FVector                                LookAtLocation;                                          // 0x15E8(0x000C) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		unsigned char                                              UnknownData_TNMT[0x4];                                   // 0x15F4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
