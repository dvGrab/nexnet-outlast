...
namespace CG
{
	...
	public:
		...
		void GetListAtColumnIndex(int32_t Index, class UW_ItemSelection_ItemList_C** Return_Value);
		void Initialize(TArray<struct FItemSelectionGroup>* InItemGroupArray);
		void Previous();
		void Next();
		void CreateNewItemList(TArray<class ABaseItem*>* Items, int32_t Index, class UW_ItemSelection_ItemList_C** Return_Value);
