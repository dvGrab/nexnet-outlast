...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_2QXN[0x7];                                   // 0x08C9(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		class FScriptMulticastDelegate                             OnMenuExited;                                            // 0x0930(0x0010) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable
		...
		unsigned char                                              UnknownData_IQPJ[0x7];                                   // 0x09E1(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_VD8Y[0x7];                                   // 0x0A09(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_DDK7[0x2];                                   // 0x0BF2(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void Try_Assign_Unbindable_Control(const struct FSKeybinding& Keybinding, bool* bSuccess);
		...
		void SwitchTab(class UW_Button_C* Button, class UWidget* MenuWidget, const class FText& Tab_Name, bool bShowResetButton);
		void Initialise_Or_Get_Pop_Up(class UClass* PopUpType, const struct FSStandardModalDetails& StandardModalDetails, class UW_StandardModal_C** OutputPopUp);
		...
		void Conflicting_Bind_Cancel_Clicked(class UW_StandardModal_C* CallingModal);
