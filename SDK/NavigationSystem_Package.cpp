...
namespace CG
{
	...
	UClass* UNavArea_Traversable3::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass("Class NavigationSystem.NavArea_Traversable3");
		return ptr;
	}
	...
	UClass* UNavArea_Traversable5::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass("Class NavigationSystem.NavArea_Traversable5");
		return ptr;
	}
	...
	UClass* UNavArea_Traversable10::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass("Class NavigationSystem.NavArea_Traversable10");
		return ptr;
	}
	...
	UClass* UNavArea_Traversable25::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass("Class NavigationSystem.NavArea_Traversable25");
		return ptr;
	}
	...
	UClass* UNavArea_Traversable50::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass("Class NavigationSystem.NavArea_Traversable50");
		return ptr;
	}
