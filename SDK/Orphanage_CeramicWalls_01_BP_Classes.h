...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass Orphanage_CeramicWalls_01_BP.Orphanage_CeramicWalls-01_BP_C
	 * Size -> 0x0018 (FullSize[0x05A8] - InheritedSize[0x0590])
	 */
	class AOrphanage_CeramicWalls__BP_C : public AWall__BP_C
	{
	public:
		...
		unsigned char                                              UnknownData_5FEI[0x5];                                   // 0x0593(0x0005) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
