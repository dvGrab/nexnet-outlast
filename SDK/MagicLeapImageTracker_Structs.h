...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_W4KA[0x3];                                   // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		struct FCoreUObject_FVector                                Location;                                                // 0x0004(0x000C) Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic
		struct FCoreUObject_FRotator                               Rotation;                                                // 0x0010(0x000C) Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, EditConst, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic
	};
	...
	public:
		...
		unsigned char                                              UnknownData_6GCI[0x2];                                   // 0x001E(0x0002) MISSED OFFSET (PADDING)
	};
