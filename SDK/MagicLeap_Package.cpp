...
namespace CG
{
	 ...
	 * 		Flags  -> ()
	 * Parameters:
	 * 		struct FCoreUObject_FRotator                       InBaseRotation                                             (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	 */
	void UMagicLeapHMDFunctionLibrary::SetBaseRotation(const struct FCoreUObject_FRotator& InBaseRotation)
	{
		static UFunction* fn = nullptr;
		if (!fn)
	 ...
	 * 		Flags  -> ()
	 * Parameters:
	 * 		struct FCoreUObject_FVector                        InBasePosition                                             (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	 */
	void UMagicLeapHMDFunctionLibrary::SetBasePosition(const struct FCoreUObject_FVector& InBasePosition)
	{
		static UFunction* fn = nullptr;
		if (!fn)
	 ...
	 * 		Flags  -> ()
	 * Parameters:
	 * 		struct FCoreUObject_FQuat                          InBaseOrientation                                          (ConstParm, Parm, OutParm, ReferenceParm, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	 */
	void UMagicLeapHMDFunctionLibrary::SetBaseOrientation(const struct FCoreUObject_FQuat& InBaseOrientation)
	{
		static UFunction* fn = nullptr;
		if (!fn)
	 ...
	 * 		TArray<struct FCoreUObject_FVector>                Vertices                                                   (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, NativeAccessSpecifierPublic)
	 * 		TArray<int32_t>                                    Triangles                                                  (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, NativeAccessSpecifierPublic)
	 * 		TArray<struct FCoreUObject_FVector>                Normals                                                    (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, NativeAccessSpecifierPublic)
	 * 		TArray<float>                                      Confidence                                                 (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, NativeAccessSpecifierPublic)
	 */
	void UMagicLeapMeshTrackerComponent::OnMeshTrackerUpdated__DelegateSignature(const struct FGuid& ID, TArray<struct FCoreUObject_FVector> Vertices, TArray<int32_t> Triangles, TArray<struct FCoreUObject_FVector> Normals, TArray<float> Confidence)
	{
		static UFunction* fn = nullptr;
		if (!fn)
	 ...
	 * 		struct FCoreUObject_FVector                        UpVector                                                   (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	 ...
	 */
	struct FMagicLeapRaycastQueryParams UMagicLeapRaycastFunctionLibrary::MakeRaycastQueryParams(const struct FCoreUObject_FVector& Position, const struct FCoreUObject_FVector& Direction, const struct FCoreUObject_FVector& UpVector, int32_t Width, int32_t Height, float HorizontalFovDegrees, bool CollideWithUnobserved, int32_t UserData)
	{
		static UFunction* fn = nullptr;
		if (!fn)
