...
namespace CG
{
	...
	float UAC_ConstantOne_C::Score(const struct FAIActionDecisionContext& Context, bool* bSuccess)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function AC_ConstantOne.AC_ConstantOne_C.Score");
		
		UAC_ConstantOne_C_Score_Params params {};
	...
	UClass* UAC_ConstantOne_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass("BlueprintGeneratedClass AC_ConstantOne.AC_ConstantOne_C");
		return ptr;
	}
