...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass SP_Utility_SmallBattery_BP.SP-Utility-SmallBattery_BP_C
	 * Size -> 0x0040 (FullSize[0x03A0] - InheritedSize[0x0360])
	 */
	class ASPUtilitySmallBattery_BP_C : public ABase_OpenSpaceContainer_BP_C
	{
	public:
		...
		unsigned char                                              UnknownData_ICEZ[0x8];                                   // 0x0368(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
