...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_GQMY[0x1];                                   // 0x098B(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_R4UC[0x7];                                   // 0x0999(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
