...
namespace CG
{
	 ...
	 */
	struct UANIMBP_Taser_C_AnimGraph_Params
	{
	public:
	 ...
	 */
	struct UANIMBP_Taser_C_AnimNotify_DropSpeedReloadMagazine_Params
	{	};

	/**
	 * Function ANIMBP_Taser.ANIMBP_Taser_C.AnimNotify_ShowMag
	 */
	struct UANIMBP_Taser_C_AnimNotify_ShowMag_Params
	{	};

	/**
	 * Function ANIMBP_Taser.ANIMBP_Taser_C.ExecuteUbergraph_ANIMBP_Taser
	 */
	struct UANIMBP_Taser_C_ExecuteUbergraph_ANIMBP_Taser_Params
	{
	public:
