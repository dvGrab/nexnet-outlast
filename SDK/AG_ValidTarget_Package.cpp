...
namespace CG
{
	...
	bool UAG_ValidTarget_C::CanOpen(const struct FAIActionDecisionContext& Context)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function AG_ValidTarget.AG_ValidTarget_C.CanOpen");
		
		UAG_ValidTarget_C_CanOpen_Params params {};
	...
	UClass* UAG_ValidTarget_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass("BlueprintGeneratedClass AG_ValidTarget.AG_ValidTarget_C");
		return ptr;
	}
