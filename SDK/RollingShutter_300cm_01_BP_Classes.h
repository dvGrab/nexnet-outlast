...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass RollingShutter_300cm_01_BP.RollingShutter-300cm-01_BP_C
	 * Size -> 0x0020 (FullSize[0x0438] - InheritedSize[0x0418])
	 */
	class ARollingShutter300cm01_BP_C : public ARBTriggerable
	{
	public:
		unsigned char                                              UnknownData_68JE[0x8];                                   // 0x0418(0x0008) Fix Super Size
	...
	public:
		...
		void ExecuteUbergraph_RollingShutter300cm01_BP(int32_t EntryPoint);
