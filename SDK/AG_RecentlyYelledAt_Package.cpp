...
namespace CG
{
	...
	bool UAG_RecentlyYelledAt_C::CanOpen(const struct FAIActionDecisionContext& Context)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function AG_RecentlyYelledAt.AG_RecentlyYelledAt_C.CanOpen");
		
		UAG_RecentlyYelledAt_C_CanOpen_Params params {};
	...
	UClass* UAG_RecentlyYelledAt_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass("BlueprintGeneratedClass AG_RecentlyYelledAt.AG_RecentlyYelledAt_C");
		return ptr;
	}
