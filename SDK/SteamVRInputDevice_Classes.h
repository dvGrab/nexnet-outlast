...
namespace CG
{
	...
	public:
		...
		bool GetSteamVR_HandPoseRelativeToNow(struct FCoreUObject_FVector* Position, struct FCoreUObject_FRotator* Orientation, ESteamVRHand hand, float PredictedSecondsFromNow);
		...
		void GetRightHandPoseData(struct FCoreUObject_FVector* Position, struct FCoreUObject_FRotator* Orientation, struct FCoreUObject_FVector* AngularVelocity, struct FCoreUObject_FVector* Velocity);
		void GetPoseSource(bool* bUsingSkeletonPose);
		void GetLeftHandPoseData(struct FCoreUObject_FVector* Position, struct FCoreUObject_FRotator* Orientation, struct FCoreUObject_FVector* AngularVelocity, struct FCoreUObject_FVector* Velocity);
	...
	public:
		...
		struct FCoreUObject_FVector                                TrackingReferenceScale;                                  // 0x00D4(0x000C) Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic
		...
		unsigned char                                              UnknownData_BAD2[0x18];                                  // 0x00F0(0x0018) MISSED OFFSET (PADDING)
