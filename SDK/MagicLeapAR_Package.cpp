...
namespace CG
{
	 ...
	 */
	bool ULuminARFrameFunctionLibrary::LuminARLineTrace(class UObject* WorldContextObject, const struct FCoreUObject_FVector2D& ScreenPosition, TArray<struct FARTraceResult>* OutHitResults)
	{
		static UFunction* fn = nullptr;
		if (!fn)
