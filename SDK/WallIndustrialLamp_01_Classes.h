...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass WallIndustrialLamp_01.WallIndustrialLamp-01_C
	 * Size -> 0x0022 (FullSize[0x0780] - InheritedSize[0x075E])
	 */
	class AWallIndustrialLamp__C : public ARBLight_BP_C
	{
	public:
		unsigned char                                              UnknownData_NK9P[0x2];                                   // 0x075E(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
