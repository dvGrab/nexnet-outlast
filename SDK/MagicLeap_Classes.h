...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_B1WP[0x8];                                   // 0x0120(0x0008) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_6FRE[0x50];                                  // 0x0180(0x0050) MISSED OFFSET (PADDING)
	...
	public:
		...
		void SetBaseRotation(const struct FCoreUObject_FRotator& InBaseRotation);
		void SetBasePosition(const struct FCoreUObject_FVector& InBasePosition);
		void SetBaseOrientation(const struct FCoreUObject_FQuat& InBaseOrientation);
		bool SetAppReady();
	...
	{
	public:
		unsigned char                                              UnknownData_DSUZ[0x8];                                   // 0x01F8(0x0008) Fix Super Size
		...
		unsigned char                                              UnknownData_XTD2[0x6];                                   // 0x0212(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_AWEW[0x3];                                   // 0x0221(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_9VD0[0x3];                                   // 0x0229(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_EBNC[0x5];                                   // 0x0233(0x0005) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_8KPX[0x7];                                   // 0x0269(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_IKCE[0x14];                                  // 0x027C(0x0014) MISSED OFFSET (PADDING)
	...
	public:
		...
		void OnMeshTrackerUpdated__DelegateSignature(const struct FGuid& ID, TArray<struct FCoreUObject_FVector> Vertices, TArray<int32_t> Triangles, TArray<struct FCoreUObject_FVector> Normals, TArray<float> Confidence);
	...
	public:
		...
		unsigned char                                              UnknownData_MOZI[0x5];                                   // 0x002B(0x0005) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_MCOI[0x68];                                  // 0x00B0(0x0068) MISSED OFFSET (PADDING)
	...
	{
	public:
		struct FMagicLeapRaycastQueryParams MakeRaycastQueryParams(const struct FCoreUObject_FVector& Position, const struct FCoreUObject_FVector& Direction, const struct FCoreUObject_FVector& UpVector, int32_t Width, int32_t Height, float HorizontalFovDegrees, bool CollideWithUnobserved, int32_t UserData);
		static UClass* StaticClass();
	};
