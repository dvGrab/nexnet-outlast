...
namespace CG
{
	...
	float UAC_Threat_C::Score(const struct FAIActionDecisionContext& Context, bool* bSuccess)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function AC_Threat.AC_Threat_C.Score");
		
		UAC_Threat_C_Score_Params params {};
	...
	UClass* UAC_Threat_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass("BlueprintGeneratedClass AC_Threat.AC_Threat_C");
		return ptr;
	}
