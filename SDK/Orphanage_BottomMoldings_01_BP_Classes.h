...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass Orphanage_BottomMoldings_01_BP.Orphanage_BottomMoldings-01_BP_C
	 * Size -> 0x0002 (FullSize[0x0413] - InheritedSize[0x0411])
	 */
	class AOrphanage_BottomMoldings__BP_C : public AMeshPopulate_BP_C
	{
	public:
