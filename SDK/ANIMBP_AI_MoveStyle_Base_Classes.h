...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_KCVF[0x3];                                   // 0xA1DD(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_FO73[0x3];                                   // 0xA1ED(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		float                                                      Delta_Time_X;                                            // 0xA1F0(0x0004) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
