...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_QGWX[0x7];                                   // 0x0341(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		class FScriptMulticastDelegate                             OnButtonClicked;                                         // 0x0348(0x0010) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable
		class FScriptMulticastDelegate                             OnButtonHovered;                                         // 0x0358(0x0010) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable
		class FScriptMulticastDelegate                             OnChildButtonClicked;                                    // 0x0368(0x0010) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable
		...
		unsigned char                                              UnknownData_IVLX[0x1];                                   // 0x0383(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_U20O[0x4];                                   // 0x038C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void GetAllUncollapsedLoadoutItemWidgets(TArray<class UW_LoadoutItem_C*>* Return_Value);
		ESlateVisibility Get_SelectedItemInfo_Container_Visibility();
		void GetAllTacticalDeviceClassesExpectGrenades(TArray<class UClass*>* Return_Value);
		void GetAllGrenadeClasses(TArray<class UClass*>* Return_Value);
