...
namespace CG
{
	...
	{
	public:
		bool LuminARLineTrace(class UObject* WorldContextObject, const struct FCoreUObject_FVector2D& ScreenPosition, TArray<struct FARTraceResult>* OutHitResults);
	...
	public:
		...
		unsigned char                                              UnknownData_C8GC[0xA8];                                  // 0x0238(0x00A8) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_W6DK[0x3];                                   // 0x0179(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		struct FCoreUObject_FVector                                PlaneSearchExtents;                                      // 0x017C(0x000C) ZeroConstructor, Deprecated, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic
		...
		unsigned char                                              UnknownData_E1BR[0x6];                                   // 0x019A(0x0006) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_K6N1[0x5];                                   // 0x005B(0x0005) MISSED OFFSET (PADDING)
