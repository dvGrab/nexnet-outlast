...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_IMXV[0x2];                                   // 0x036E(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_OKOK[0x3];                                   // 0x0375(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void On_Center_Print(const class FName& Message_Type, float Duration, class APlayerCharacter* Other);
