...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_1KDV[0x2];                                   // 0x022E(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_UPFZ[0xF0];                                  // 0x02E0(0x00F0) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_XPUT[0x7];                                   // 0x0259(0x0007) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_UCXH[0x7];                                   // 0x0249(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		TMap<struct FGuid, class AMagicLeapARPinInfoActorBase*>    AllInfoActors;                                           // 0x0250(0x0050) NativeAccessSpecifierPrivate
		unsigned char                                              UnknownData_ZLAJ[0x8];                                   // 0x02A0(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_JAJS[0x8];                                   // 0x0038(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_BNNV[0xF];                                   // 0x00A1(0x000F) MISSED OFFSET (PADDING)
