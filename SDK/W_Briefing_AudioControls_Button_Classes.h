...
namespace CG
{
	...
	public:
		...
		bool                                                       FlipIcon_Horiz;                                          // 0x028A(0x0001) Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor
		unsigned char                                              UnknownData_ZC0Y[0x5];                                   // 0x028B(0x0005) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		class FText                                                LabelText;                                               // 0x0290(0x0018) Edit, BlueprintVisible
		class FText                                                ActiveLabelText;                                         // 0x02A8(0x0018) Edit, BlueprintVisible
		class FScriptMulticastDelegate                             AudioControlButtonClicked;                               // 0x02C0(0x0010) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable
		struct FSlateBrush                                         Icon;                                                    // 0x02D0(0x0088) Edit, BlueprintVisible
		class FScriptMulticastDelegate                             AudioControlButtonPressed;                               // 0x0358(0x0010) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable
		class FScriptMulticastDelegate                             AudioControlButtonReleased;                              // 0x0368(0x0010) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable
		class FScriptMulticastDelegate                             AudioControlButtonHovered;                               // 0x0378(0x0010) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable
		...
		unsigned char                                              UnknownData_K88M[0x7];                                   // 0x0399(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
