...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_HOOY[0x3];                                   // 0x005D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		struct FExpressionInput                                    Coordinates;                                             // 0x0060(0x0014) NoDestructor, Protected, NativeAccessSpecifierProtected
		unsigned char                                              ConstCoordinateIndex;                                    // 0x0074(0x0001) Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected
		unsigned char                                              UnknownData_BIQ3[0x3];                                   // 0x0075(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
	public:
		bool ConvertSVGToMSDFData(const class FString& FilePath, const struct FSVGConversionParams& Params, TArray<unsigned char>* Output);
		static UClass* StaticClass();
	};
