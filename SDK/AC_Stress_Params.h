...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function AC_Stress.AC_Stress_C.Score
	 */
	struct UAC_Stress_C_Score_Params
	{
	public:
		...
		unsigned char                                              UnknownData_B3IT[0x3];                                   // 0x0011(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
