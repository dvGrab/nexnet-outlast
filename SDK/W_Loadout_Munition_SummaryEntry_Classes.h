...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_G3YR[0x2];                                   // 0x02C2(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		class FText                                                Ammo_Variety;                                            // 0x04D8(0x0018) Edit, BlueprintVisible, DisableEditOnInstance
		class FText                                                Ammo_Caliber;                                            // 0x04F0(0x0018) Edit, BlueprintVisible, DisableEditOnInstance
	...
	public:
		...
		void UpdateAmmunition(class UClass* Weapon, const class FName& AmmoType, int32_t Count);
		void UpdateItem(class UClass* ItemData, int32_t Count);
