...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_X8RU[0x4];                                   // 0x0374(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		TArray<class AActor*>                                      DamagedActorsMap;                                        // 0x0378(0x0010) Edit, BlueprintVisible, DisableEditOnTemplate, DisableEditOnInstance
		class AReadyOrNotCharacter*                                Triggered_By;                                            // 0x0388(0x0008) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash

	public:
		void CanApplyDamage(class UDamageType* InDamageType, bool* Return_Value);
		void Explode_Trap();
		...
		void ReceivePointDamage(float Damage, class UDamageType* DamageType, const struct FCoreUObject_FVector& HitLocation, const struct FCoreUObject_FVector& HitNormal, class UPrimitiveComponent* HitComponent, const class FName& BoneName, const struct FCoreUObject_FVector& ShotFromDirection, class AController* InstigatedBy, class AActor* DamageCauser, const struct FHitResult& HitInfo);
		void ReceiveRadialDamage(float DamageReceived, class UDamageType* DamageType, const struct FCoreUObject_FVector& Origin, const struct FHitResult& HitInfo, class AController* InstigatedBy, class AActor* DamageCauser);
