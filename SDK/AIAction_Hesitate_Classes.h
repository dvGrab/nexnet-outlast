...
namespace CG
{
	...
	public:
		...
		struct FCoreUObject_FVector                                HesitateMoveLocation;                                    // 0x0050(0x000C) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		struct FCoreUObject_FVector                                LastSeenSwatLocation;                                    // 0x005C(0x000C) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
