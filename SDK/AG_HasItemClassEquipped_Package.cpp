...
namespace CG
{
	...
	bool UAG_HasItemClassEquipped_C::CanOpen(const struct FAIActionDecisionContext& Context)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function AG_HasItemClassEquipped.AG_HasItemClassEquipped_C.CanOpen");
		
		UAG_HasItemClassEquipped_C_CanOpen_Params params {};
	...
	UClass* UAG_HasItemClassEquipped_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass("BlueprintGeneratedClass AG_HasItemClassEquipped.AG_HasItemClassEquipped_C");
		return ptr;
	}
