...
namespace CG
{
	...
	float UAC_VisibleSWAT_C::Score(const struct FAIActionDecisionContext& Context, bool* bSuccess)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function AC_VisibleSWAT.AC_VisibleSWAT_C.Score");
		
		UAC_VisibleSWAT_C_Score_Params params {};
	...
	UClass* UAC_VisibleSWAT_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass("BlueprintGeneratedClass AC_VisibleSWAT.AC_VisibleSWAT_C");
		return ptr;
	}
