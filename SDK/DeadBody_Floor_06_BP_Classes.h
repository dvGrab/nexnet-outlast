...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass DeadBody_Floor_06_BP.DeadBody_Floor-06_BP_C
	 * Size -> 0x000F (FullSize[0x04E8] - InheritedSize[0x04D9])
	 */
	class ADeadBody_Floor06_BP_C : public ADeadBodyBase_BP_C
	{
	public:
		unsigned char                                              UnknownData_717S[0x7];                                   // 0x04D9(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
