...
namespace CG
{
	...
	void USE_MansionTheatre_Curtain_AnimBP_C::AnimGraph(struct FPoseLink* AnimGraph)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function SE_MansionTheatre_Curtain_AnimBP.SE_MansionTheatre_Curtain_AnimBP_C.AnimGraph");
	...
	void USE_MansionTheatre_Curtain_AnimBP_C::ExecuteUbergraph_SE_MansionTheatre_Curtain_AnimBP(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function SE_MansionTheatre_Curtain_AnimBP.SE_MansionTheatre_Curtain_AnimBP_C.ExecuteUbergraph_SE_MansionTheatre_Curtain_AnimBP");
	...
	UClass* USE_MansionTheatre_Curtain_AnimBP_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass("AnimBlueprintGeneratedClass SE_MansionTheatre_Curtain_AnimBP.SE_MansionTheatre_Curtain_AnimBP_C");
		return ptr;
	}
