...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass ExecutionWitness_Chair_04_BP.ExecutionWitness_Chair_04_BP_C
	 * Size -> 0x0057 (FullSize[0x0308] - InheritedSize[0x02B1])
	 */
	class AExecutionWitness_Chair_04_BP_C : public AExecutionActorBase_BP_C
	{
	public:
		unsigned char                                              UnknownData_EOZJ[0x7];                                   // 0x02B1(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
