...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_KHB1[0x2];                                   // 0x0052(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		struct FCoreUObject_FVector                                FocalPoint;                                              // 0x0054(0x000C) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash

	public:
		void IsFakeExit(ESurrenderExitType ExitType, bool* Return_Value);
