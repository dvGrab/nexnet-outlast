...
namespace CG
{
	...
	float UAC_Suppression_C::Score(const struct FAIActionDecisionContext& Context, bool* bSuccess)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function AC_Suppression.AC_Suppression_C.Score");
		
		UAC_Suppression_C_Score_Params params {};
	...
	UClass* UAC_Suppression_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass("BlueprintGeneratedClass AC_Suppression.AC_Suppression_C");
		return ptr;
	}
