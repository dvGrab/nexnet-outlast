...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_VA8D[0x4];                                   // 0x02DC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_MK72[0x1];                                   // 0x0343(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		struct FCoreUObject_FVector2D                              NudgeAmount;                                             // 0x0344(0x0008) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
	...
	public:
		...
		void GetSelectedItem(class ABaseItem** Return_Value);
