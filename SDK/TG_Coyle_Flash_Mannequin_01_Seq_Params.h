...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function TG_Coyle_Flash_Mannequin-01_Seq.SequenceDirector_C.SequenceEvent__ENTRYPOINTSequenceDirector_2
	 */
	...
	/**
	 * Function TG_Coyle_Flash_Mannequin-01_Seq.SequenceDirector_C.SequenceEvent__ENTRYPOINTSequenceDirector_1
	 */
	...
	/**
	 * Function TG_Coyle_Flash_Mannequin-01_Seq.SequenceDirector_C.DrugCoyle_Event_1
	 */
	...
	/**
	 * Function TG_Coyle_Flash_Mannequin-01_Seq.SequenceDirector_C.DrugCoyle_Event_2
	 */
	...
	/**
	 * Function TG_Coyle_Flash_Mannequin-01_Seq.SequenceDirector_C.ExecuteUbergraph_SequenceDirector
	 */
	struct USequenceDirector_C_ExecuteUbergraph_SequenceDirector_Params
	{
	public:
		int32_t                                                    EntryPoint;                                              // 0x0000(0x0004)  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
		unsigned char                                              UnknownData_Z3XR[0x4];                                   // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
