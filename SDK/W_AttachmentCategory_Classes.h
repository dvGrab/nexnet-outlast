...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_UKZZ[0x7];                                   // 0x0321(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		class FScriptMulticastDelegate                             OnAttachmentItemButtonClicked;                           // 0x0358(0x0010) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable
	...
	public:
		...
		void IsValidGridIndex(int32_t InRow, int32_t InColumn, bool* Return_Value);
		void FindGridIndexFromAttachmentItemWidget(class UW_AttachmentItem_C* InAttachmentItemWidget, int32_t* Out_Row, int32_t* Out_Column);
		void FindAttachmentItemWidgetAt(int32_t InRow, int32_t InColumn, class UW_AttachmentItem_C** Return_Value);
		...
		void CreateAttachmentItemWidget(class UClass* AttachmentItemClass, int32_t InRow, int32_t InColumn);
		void ExpandChildren();
