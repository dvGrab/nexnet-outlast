...
namespace CG
{
	...
	{
	public:
		struct FCoreUObject_FRotator                               RotationalAcceleration;                                  // 0x0AF0(0x000C) Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic
		struct FCoreUObject_FRotator                               RotationalDeceleration;                                  // 0x0AFC(0x000C) Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic
		struct FCoreUObject_FRotator                               MaxRotationalVelocity;                                   // 0x0B08(0x000C) Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic
		...
		unsigned char                                              UnknownData_8HYL[0x18];                                  // 0x0B28(0x0018) MISSED OFFSET (PADDING)
