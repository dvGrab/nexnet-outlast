...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass SJ_Telephone_04_BP.SJ_Telephone-04_BP_C
	 * Size -> 0x0028 (FullSize[0x0510] - InheritedSize[0x04E8])
	 */
	class ASJ_Telephone04_BP_C : public ARBScareJumpBase_C
	{
	public:
	...
	public:
		...
		void ExecuteUbergraph_SJ_Telephone04_BP(int32_t EntryPoint);
