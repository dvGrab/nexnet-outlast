...
namespace CG
{
	...
	struct FEventReply USocialMenu_Tab_SleepRoom_C::OnFocusReceived(const struct FGeometry& MyGeometry, const struct FFocusEvent& InFocusEvent)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function SocialMenu_Tab_SleepRoom.SocialMenu_Tab_SleepRoom_C.OnFocusReceived");
	...
	void USocialMenu_Tab_SleepRoom_C::Deactivate()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function SocialMenu_Tab_SleepRoom.SocialMenu_Tab_SleepRoom_C.Deactivate");
	...
	void USocialMenu_Tab_SleepRoom_C::Activate(class URBSocialMenuManager* SocialMenu)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function SocialMenu_Tab_SleepRoom.SocialMenu_Tab_SleepRoom_C.Activate");
	...
	UClass* USocialMenu_Tab_SleepRoom_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass("WidgetBlueprintGeneratedClass SocialMenu_Tab_SleepRoom.SocialMenu_Tab_SleepRoom_C");
		return ptr;
	}
