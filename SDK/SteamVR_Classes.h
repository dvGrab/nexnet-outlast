...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_CMK2[0x8];                                   // 0x00D0(0x0008) MISSED OFFSET (PADDING)

	public:
		void SteamVRChaperoneEvent__DelegateSignature();
		TArray<struct FCoreUObject_FVector> GetBounds();
	...
	public:
		...
		bool GetTrackedDevicePositionAndOrientation(int32_t DeviceID, struct FCoreUObject_FVector* OutPosition, struct FCoreUObject_FRotator* OutOrientation);
		bool GetHandPositionAndOrientation(int32_t ControllerIndex, EControllerHand hand, struct FCoreUObject_FVector* OutPosition, struct FCoreUObject_FRotator* OutOrientation);
		static UClass* StaticClass();
	};
	...
	public:
		...
		unsigned char                                              UnknownData_K68G[0x2];                                   // 0x002A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_2H6U[0x4];                                   // 0x0034(0x0004) MISSED OFFSET (PADDING)
