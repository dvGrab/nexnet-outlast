...
namespace CG
{
	...
	public:
		...
		class FScriptMulticastDelegate                             OnModifyWeaponButtonClick;                               // 0x0290(0x0010) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable
		...
		class FScriptMulticastDelegate                             OnAttachmentItemClicked;                                 // 0x02B8(0x0010) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable
