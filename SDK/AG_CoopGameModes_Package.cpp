...
namespace CG
{
	...
	bool UAG_CoopGameModes_C::CanOpen(const struct FAIActionDecisionContext& Context)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function AG_CoopGameModes.AG_CoopGameModes_C.CanOpen");
		
		UAG_CoopGameModes_C_CanOpen_Params params {};
	...
	UClass* UAG_CoopGameModes_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass("BlueprintGeneratedClass AG_CoopGameModes.AG_CoopGameModes_C");
		return ptr;
	}
