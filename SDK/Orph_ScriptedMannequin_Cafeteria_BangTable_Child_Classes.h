...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass Orph_ScriptedMannequin_Cafeteria_BangTable_Child.Orph_ScriptedMannequin_Cafeteria_BangTable_Child_C
	 * Size -> 0x0010 (FullSize[0x0488] - InheritedSize[0x0478])
	 */
	class AOrph_ScriptedMannequin_Cafeteria_BangTable_Child_C : public AOrph_ScriptedMannequin_CafeteriaBase_C
	{
	public:
