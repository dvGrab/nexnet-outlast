...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass CeilingFluorescentLightBase_01.CeilingFluorescentLightBase-01_C
	 * Size -> 0x001A (FullSize[0x0778] - InheritedSize[0x075E])
	 */
	class ACeilingFluorescentLightBase__C : public ARBLight_BP_C
	{
	public:
		unsigned char                                              UnknownData_ZRBX[0x2];                                   // 0x075E(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
