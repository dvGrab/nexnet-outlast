...
namespace CG
{
	 ...
	 * Function:
	 * 		RVA    -> 0x00000000
	 * 		Name   -> Function TG_Middle-01_Seq.SequenceDirector_C.SequenceEvent__ENTRYPOINTSequenceDirector_1
	 * 		Flags  -> ()
	 * Parameters:
	...
	void USequenceDirector_C::SequenceEvent__ENTRYPOINTSequenceDirector_1(class AEmitter* SmokeCorridor400_PS)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function TG_Middle-01_Seq.SequenceDirector_C.SequenceEvent__ENTRYPOINTSequenceDirector_1");
	 ...
	 * Function:
	 * 		RVA    -> 0x00000000
	 * 		Name   -> Function TG_Middle-01_Seq.SequenceDirector_C.SmokeCorridor400_PS_Event_1
	 * 		Flags  -> ()
	 * Parameters:
	 * 		class AEmitter*                                    SmokeCorridor400_PS                                        (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	 */
	void USequenceDirector_C::SmokeCorridor400_PS_Event_1(class AEmitter* SmokeCorridor400_PS)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function TG_Middle-01_Seq.SequenceDirector_C.SmokeCorridor400_PS_Event_1");
	 ...
	 * Function:
	 * 		RVA    -> 0x00000000
	 * 		Name   -> Function TG_Middle-01_Seq.SequenceDirector_C.ExecuteUbergraph_SequenceDirector
	 * 		Flags  -> ()
	 * Parameters:
	...
	void USequenceDirector_C::ExecuteUbergraph_SequenceDirector(int32_t EntryPoint)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function TG_Middle-01_Seq.SequenceDirector_C.ExecuteUbergraph_SequenceDirector");
	...
	UClass* USequenceDirector_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass("BlueprintGeneratedClass TG_Middle_01_Seq.SequenceDirector_C");
		return ptr;
	}
