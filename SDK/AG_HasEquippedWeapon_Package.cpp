...
namespace CG
{
	...
	bool UAG_HasEquippedWeapon_C::CanOpen(const struct FAIActionDecisionContext& Context)
	{
		...
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function AG_HasEquippedWeapon.AG_HasEquippedWeapon_C.CanOpen");
		
		UAG_HasEquippedWeapon_C_CanOpen_Params params {};
	...
	UClass* UAG_HasEquippedWeapon_C::StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass("BlueprintGeneratedClass AG_HasEquippedWeapon.AG_HasEquippedWeapon_C");
		return ptr;
	}
