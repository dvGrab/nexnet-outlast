...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_0XIF[0x8];                                   // 0x0028(0x0008) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_SN1U[0x18];                                  // 0x0078(0x0018) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_N62P[0x50];                                  // 0x0090(0x0050) MISSED OFFSET (PADDING)
