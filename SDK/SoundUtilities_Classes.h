...
namespace CG
{
	...
	public:
		...
		float GetLogFrequencyClamped(float InValue, const struct FCoreUObject_FVector2D& InDomain, const struct FCoreUObject_FVector2D& InRange);
		float GetLinearFrequencyClamped(float InValue, const struct FCoreUObject_FVector2D& InDomain, const struct FCoreUObject_FVector2D& InRange);
