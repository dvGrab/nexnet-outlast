...
namespace CG
{
	 ...
	 */
	struct UW_Loadout_ItemList_Vertical_C_UpdateScrollPage_Params
	{	};
	...
	public:
		...
		unsigned char                                              UnknownData_W4KO[0x7];                                   // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	 ...
	 */
	struct UW_Loadout_ItemList_Vertical_C_GetItemArrayBySlot_Params
	{	};
	 ...
	 */
	struct UW_Loadout_ItemList_Vertical_C_PopulateSubnav_Params
	{	};

	/**
	 * Function W_Loadout_ItemList_Vertical.W_Loadout_ItemList_Vertical_C.OpenList
	 */
	struct UW_Loadout_ItemList_Vertical_C_OpenList_Params
	{	};
	 ...
	 */
	struct UW_Loadout_ItemList_Vertical_C_ScrollOpenedToEquipped_Params
	{	};
	...
	public:
		...
		unsigned char                                              UnknownData_WEVV[0x7];                                   // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	 ...
	 */
	struct UW_Loadout_ItemList_Vertical_C_Construct_Params
	{	};
	 ...
	 */
	struct UW_Loadout_ItemList_Vertical_C_HideList_Params
	{	};
	...
	public:
		EItemCategory                                              LoadoutSlot;                                             // 0x0000(0x0001)  (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
		unsigned char                                              UnknownData_13UL[0x7];                                   // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
		TArray<struct FLoadoutCategory>                            GearCategoryClasses;                                     // 0x0008(0x0010)  (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm)
	 ...
	 */
	struct UW_Loadout_ItemList_Vertical_C_InitializeArmourMaterialList_Params
	{	};
	...
	public:
		...
		unsigned char                                              UnknownData_3L9E[0x4];                                   // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
