...
namespace CG
{
	 ...
	 * 		Flags  -> ()
	 */
	TArray<struct FCoreUObject_FVector> USteamVRChaperoneComponent::GetBounds()
	{
		static UFunction* fn = nullptr;
		if (!fn)
	 ...
	 * 		struct FCoreUObject_FVector                        OutPosition                                                (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	 * 		struct FCoreUObject_FRotator                       OutOrientation                                             (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	 */
	bool USteamVRFunctionLibrary::GetTrackedDevicePositionAndOrientation(int32_t DeviceID, struct FCoreUObject_FVector* OutPosition, struct FCoreUObject_FRotator* OutOrientation)
	{
		static UFunction* fn = nullptr;
		if (!fn)
	 ...
	 * 		struct FCoreUObject_FRotator                       OutOrientation                                             (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	 */
	bool USteamVRFunctionLibrary::GetHandPositionAndOrientation(int32_t ControllerIndex, EControllerHand hand, struct FCoreUObject_FVector* OutPosition, struct FCoreUObject_FRotator* OutOrientation)
	{
		static UFunction* fn = nullptr;
		if (!fn)
