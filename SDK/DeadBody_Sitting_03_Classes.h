...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass DeadBody_Sitting_03.DeadBody_Sitting-03_C
	 * Size -> 0x0017 (FullSize[0x04F0] - InheritedSize[0x04D9])
	 */
	class ADeadBody_Sitting03_C : public ADeadBodyBase_BP_C
	{
	public:
		unsigned char                                              UnknownData_GGYS[0x7];                                   // 0x04D9(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
