...
namespace CG
{
	...
	public:
		...
		void FindIconFromItemClass(class UClass* ItemClass, class UTexture2D** Return_Value);
		...
		void OnLoadoutItemPresetButtonClicked_Internal(class UW_LoadoutItem_Preset_C* Loadout_Item_Preset);
		struct FEventReply OnKeyUp(const struct FGeometry& MyGeometry, const struct FKeyEvent& InKeyEvent);
		struct FEventReply OnKeyDown(const struct FGeometry& MyGeometry, const struct FKeyEvent& InKeyEvent);
		void GetCurrentlyFocusedWidget(class UWidget** Return_Value);
		ESlateVisibility Get_Quatermaster_Box_Visibility();
		void AnyLoadoutCategoryWidgetHovered(bool* Return_Value);
		void CanUnselect(bool* Return_Value);
		...
		void ScrollToBottom();
		void ScrollToTop();
		void OnLoadoutItemButtonClicked_Internal(EItemClass ItemClass, class UClass* ItemObjectClass, bool bIsTactical, int32_t TacticalSlot, bool bIsMultipleTacticalSlots, int32_t MaxTacticalSlots, int32_t Starting_Tactical_Slot, class UW_LoadoutItem_C* LastSelectedLoadoutItem);
		void OnLoadoutCategoryButtonHovered_Internal(class UW_LoadoutCategory_C* LoadoutCategory);
		void OnLoadoutCategoryButtonClicked_Internal(class UW_LoadoutCategory_C* LoadoutCategory);
		...
		void OnLoadoutItemButtonClicked(EItemClass ItemClass, class UClass* ItemObjectClass, bool bIsTactical, int32_t TacticalSlot, bool bIsMultipleTacticalSlots, int32_t MaxTacticalSlots, int32_t Starting_Tactical_Slot, class UW_LoadoutItem_C* Loadout_Item_Widget);
