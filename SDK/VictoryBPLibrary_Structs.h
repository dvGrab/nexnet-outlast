...
namespace CG
{
	...
	public:
		...
		struct FCoreUObject_FVector                                Location;                                                // 0x0010(0x000C) BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic
		struct FCoreUObject_FRotator                               Rotation;                                                // 0x001C(0x000C) BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic
		...
		unsigned char                                              UnknownData_MQ6N[0x3];                                   // 0x0029(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_ZQKZ[0x4];                                   // 0x003C(0x0004) MISSED OFFSET (PADDING)
	};
	...
	public:
		...
		unsigned char                                              UnknownData_QDYU[0x7];                                   // 0x0039(0x0007) MISSED OFFSET (PADDING)
	};
