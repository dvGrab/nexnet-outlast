...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * AnimBlueprintGeneratedClass ExecutionActor_NPC_AnimBP.ExecutionActor_NPC_AnimBP_C
	 * Size -> 0x03B8 (FullSize[0x0670] - InheritedSize[0x02B8])
	 */
	class UExecutionActor_NPC_AnimBP_C : public UAnimInstance
	{
	public:
		unsigned char                                              UnknownData_LHC2[0x8];                                   // 0x02B8(0x0008) Fix Super Size
		...
		unsigned char                                              UnknownData_7MGJ[0x7];                                   // 0x0659(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		class UAnimSequence*                                       IntroAnim;                                               // 0x0660(0x0008) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		class UAnimSequence*                                       loopAnim;                                                // 0x0668(0x0008) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
	...
	public:
		...
		void ExecuteUbergraph_ExecutionActor_NPC_AnimBP(int32_t EntryPoint);
