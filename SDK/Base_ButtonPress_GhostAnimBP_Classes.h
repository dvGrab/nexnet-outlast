...
namespace CG
{
	 ...
	 */
	class UBase_ButtonPress_GhostAnimBP_C : public URBGhostAnimInstance
	{
	public:
		unsigned char                                              UnknownData_Q8X8[0x8];                                   // 0x02E8(0x0008) Fix Super Size
		...
		unsigned char                                              UnknownData_EUWG[0x4];                                   // 0x0564(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void ExecuteUbergraph_Base_ButtonPress_GhostAnimBP(int32_t EntryPoint);
