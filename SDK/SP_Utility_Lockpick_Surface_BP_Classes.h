...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass SP_Utility_Lockpick_Surface_BP.SP-Utility-Lockpick-Surface_BP_C
	 * Size -> 0x0040 (FullSize[0x03B0] - InheritedSize[0x0370])
	 */
	class ASP_Utility_Lockpick_Surface_BP_C : public ABase_OpenSpaceContainer_BP_C
	{
	public:
		...
		unsigned char                                              UnknownData_XO4R[0x8];                                   // 0x0378(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
