...
namespace CG
{
	 ...
	 * 		struct FCoreUObject_FVector2D                      InDomain                                                   (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	 * 		struct FCoreUObject_FVector2D                      InRange                                                    (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	 */
	float USoundUtilitiesBPFunctionLibrary::GetLogFrequencyClamped(float InValue, const struct FCoreUObject_FVector2D& InDomain, const struct FCoreUObject_FVector2D& InRange)
	{
		static UFunction* fn = nullptr;
		if (!fn)
	 ...
	 * 		struct FCoreUObject_FVector2D                      InRange                                                    (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	 */
	float USoundUtilitiesBPFunctionLibrary::GetLinearFrequencyClamped(float InValue, const struct FCoreUObject_FVector2D& InDomain, const struct FCoreUObject_FVector2D& InRange)
	{
		static UFunction* fn = nullptr;
		if (!fn)
