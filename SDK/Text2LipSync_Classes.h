...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_7UI6[0x7];                                   // 0x01D9(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		class FScriptMulticastDelegate                             OnNotifyExecuted;                                        // 0x01E0(0x0010) ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic
		class FScriptMulticastDelegate                             OnPlayingFinished;                                       // 0x01F0(0x0010) ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic
		class FScriptMulticastDelegate                             OnSpeakingPause;                                         // 0x0200(0x0010) ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic
		class FScriptMulticastDelegate                             OnTimelineChanged;                                       // 0x0210(0x0010) ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic
		...
		unsigned char                                              MorphTargetsList[0x50];                                  // 0x0310(0x0050) UNKNOWN PROPERTY: SetProperty
		...
		unsigned char                                              UnknownData_G7RT[0x3];                                   // 0x0375(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_V8X1[0x4];                                   // 0x0394(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_94NH[0x3];                                   // 0x03CD(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		TMap<class FName, unsigned char>                           Emotion2Flag;                                            // 0x03D8(0x0050) Protected, NativeAccessSpecifierProtected
		TMap<unsigned char, class FName>                           Flag2Emotion;                                            // 0x0428(0x0050) Protected, NativeAccessSpecifierProtected
		TMap<unsigned char, float>                                 ActiveEmotions;                                          // 0x0478(0x0050) Protected, NativeAccessSpecifierProtected
		unsigned char                                              UnknownData_435A[0x340];                                 // 0x04C8(0x0340) MISSED OFFSET (PADDING)
